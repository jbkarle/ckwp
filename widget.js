...
cprequire_test(["inline:net-fka-ck-wp"], function(myWidget) {
...
cpdefine("inline:net-fka-ck-wp", ["chilipeppr_ready", /* other dependencies here */ ], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "net-fka-ck-wp", // Make the id the same as the cpdefine id
        name: "Widget / Way Points", // The descriptive name of your widget.
